        ...
        <div
          ...
          <div class="g-0 lg:flex lg:flex-wrap">
            ...
            <div class="px-4 md:px-0 lg:w-6/12">
              <div class="md:mx-6 md:p-18">
                <!--Logo-->
                <div class="flex flex-col text-center">
                 <svg class="h-15" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="relative mb-4 flex flex-col" data-twe-input-wrapper-init>
                        ...
                        <input class="px-4 py-1 w-full border-1 rounded" type="email" name="email" id="email" value="{{ old('email') }}">
                         @error('email')
                    ...
                    <div class="relative mb-4 flex flex-col" data-twe-input-wrapper-init>
                        ...
                        <input class="px-4 py-1 w-full border-1 rounded" type="password" name="password" id="password">
                         @error('password')
                        <div class="mt-2 p-3 text-sm text-red-700 bg-red-100 rounded-lg" role="alert">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-12 pb-1 pt-1 text-center">
                        <button
                        class="bg-teal-600 cursor-pointer hover:opacity-80 mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-dark-3 transition duration-150 ease-in-out hover:shadow-dark-2 focus:shadow-dark-2 focus:outline-none focus:ring-0 active:shadow-dark-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                        type="submit"
